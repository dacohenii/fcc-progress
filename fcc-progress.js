...
(function() {
    ...
    function copyProgressRow(){
        // join w/ tab to copy text suitable for pasting into a spreadsheet
        const row = allSectionsProgress.join('\t');
        GM_setClipboard(row, { type: 'text', mimetype: 'text/plain'});
    }

    GM_registerMenuCommand("Copy Student Progress", copyProgressRow);
